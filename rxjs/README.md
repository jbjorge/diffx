...
```
The returned object can be accessed as a regular object at any time. The object is readonly, and an error
will be thrown if it is mutated outside of `setState()`.
