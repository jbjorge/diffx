...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(empty);

var jsondiffpatch_umd = createCommonjsModule(function (module, exports) {
(function (global, factory) {
	 factory(exports, require$$0) ;
}(commonjsGlobal, (function (exports,chalk) {
...
let stateReplacementKey = null;
let stateModificationsPaused = false;
let isCreatingState = false;
let stateAccessBuffer = [];
let rootState = createReactiveObject$1();
 ...
 * @param options
 */
function setDiffxOptions(options) {
    var _a, _b;
    diffxOptions = options;
    if ((_a = options === null || options === void 0 ? void 0 : options.debug) === null || _a === void 0 ? void 0 : _a.devtools) {
        const glob = (typeof process !== 'undefined' && ((_b = process === null || process === void 0 ? void 0 : process.versions) === null || _b === void 0 ? void 0 : _b.node)) ? global : window;
        glob["__DIFFX__"] = Object.assign({ createState, setState, watchState, destroyState, setDiffxOptions }, diffxInternals);
    }
}
/**
 ...
 * @param initialState
 */
function createState(namespace, initialState) {
 ...
 */
function setState(reason, valueAssignment) {
 ...
 * @param options
 */
function watchState(stateGetter, onChangeCallback, options) {
    let oldValue;
    ...
    return effect(stateGetter, {
        ...
        onTrigger: (event) => {
            ...
            if ((options === null || options === void 0 ? void 0 : options.hasChangedComparer) && !options.hasChangedComparer(newValueClone, oldValue)) {
...
(function (diffxInternals) {
     ...
     */
    function addDiffListener(cb, lazy) {
    ...
    diffxInternals.addDiffListener = addDiffListener;
    /**
     * Removes diff listener
     * @param listenerId
     */
    function removeDiffListener(listenerId) {
    ...
    function commit() {
        const diffEntry = {
            timestamp: Date.now(),
            reason: 'Commit',
            diff: jsondiffpatch_umd.diff({}, clone(rootState))
        };
        diffs = [diffEntry];
    ...
    diffxInternals.replaceState = replaceState;
    /**
    ...
    diffxInternals.lockState = lockState;
    /**
    ...
    diffxInternals.unlockState = unlockState;
    /**
    ...
    diffxInternals.pauseState = pauseState;
    /**
    ...
    diffxInternals.unpauseState = unpauseState;
    /**
    ...
    diffxInternals.getStateSnapshot = getStateSnapshot;
    /**
    ...
    diffxInternals.getDiffs = getDiffs;
})(diffxInternals || (diffxInternals = {}));
/**
 * Creates a reactive object.
 * @param rootObj
 */
function createReactiveObject$1(rootObj = {}) {
    return new Proxy(rootObj, {
        get(target, prop, receiver) {
            ...
            if (isReplacingState || stateModificationsPaused) {
                stateAccessBuffer.push(() => track(target, "get" /* GET */, prop));
            }
            else {
                track(target, "get" /* GET */, prop);
            }
            const value = Reflect.get(target, prop, receiver);
            if (typeof value === 'object') {
                return createReactiveObject$1(value);
            }
            else {
                return value;
            }
        ...
        set(target, key, newValue, receiver) {
            ...
            if (isReplacingState) {
                if ((newValue === null || newValue === void 0 ? void 0 : newValue.__diffx_stateReplacementKey) !== stateReplacementKey) {
                    return true;
                }
            ...
            // so it can be run after the state is done being replaced
            if (isReplacingState || stateModificationsPaused) {
                stateAccessBuffer.push(() => trigger(target, "set" /* SET */, key, newValue));
            }
            else {
                trigger(target, "set" /* SET */, key, newValue);
            }
            return returnValue;
        }
    });
...
function createHistoryEntry(reason = '') {
    ...
    const historyEntry = {
        timestamp: Date.now(),
        reason,
        diff: jsondiffpatch_umd.diff(previousState, currentState)
    };
    if ((_a = diffxOptions === null || diffxOptions === void 0 ? void 0 : diffxOptions.debug) === null || _a === void 0 ? void 0 : _a.includeStackTrace) {
...
function clone(obj) {
    ...
    return JSON.parse(JSON.stringify(obj), jsondiffpatch_umd.dateReviver);
}

export { createState, destroyState, diffxInternals, setDiffxOptions, setState, watchState };
