export const missingOnDoneHandler = '[diffx] A promise was returned inside setState. Missing onDone handler.\nhttps://github.com/jbjorge/diffx/wiki/Errors-and-warnings-overview#core-10';
...
export const missingOnErrorHandler = '[diffx] setStateAsync() threw an error, but no error handler was provided.\nhttps://github.com/jbjorge/diffx/wiki/Errors-and-warnings-overview#core-19\nThe error was:';